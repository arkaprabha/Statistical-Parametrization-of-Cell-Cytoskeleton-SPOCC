...
t=imread('d:\Work\PhD\Projects\0-ESA Project\fibersClassificationJava\data_epfl_nov\raw\microgravity\res\ALIGNED_all_mean.bmp');
I=double(t(:,:,1));
...
% Save image
imwrite(gray2ind(I),jet,'path.jpg');
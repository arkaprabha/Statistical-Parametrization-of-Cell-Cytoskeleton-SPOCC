...
if (actualiter <= 1),
    pmodel.img=(imread(input_file)); pmodel.img=double(pmodel.img); pmodel.img=pmodel.img/max(pmodel.img(:))*255;
...
if ((pmodel.tt <= 5) && (pmodel.ttt <= 20)),
  pmodel.model2=run_levelset_pattern(pmodel.bimg,pmodel.sgb, pmodel.model2, actualiter, numiter, verbose);
